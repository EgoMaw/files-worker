/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3afcf457d49459fe5426cb2705f58ac0)
...
declare namespace Cloudflare {
	...
	interface Env {
		CUSTOM_PUBLIC_BUCKET_DOMAIN: "";
		ONLY_ALLOW_ACCESS_TO_PUBLIC_BUCKET: false;
		NO_FOLDERS: true;
		AUTH_KEY: string;
		R2_BUCKET: R2Bucket;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CUSTOM_PUBLIC_BUCKET_DOMAIN" | "ONLY_ALLOW_ACCESS_TO_PUBLIC_BUCKET" | "NO_FOLDERS" | "AUTH_KEY">> {}
}
